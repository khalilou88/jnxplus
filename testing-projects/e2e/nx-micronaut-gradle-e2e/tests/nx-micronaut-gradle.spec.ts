...
describe('nx-micronaut-gradle e2e', () => {
  ...
  beforeAll(async () => {
    ...
    const pluginName = '@jnxplus/nx-micronaut-gradle';
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:init --rootProjectName ${rootProjectName}`
    );
  ...
  it('should init the workspace with @jnxplus/nx-micronaut-gradle capabilities', async () => {
    // Making sure the package.json file contains the @jnxplus/nx-micronaut-gradle dependency
    const packageJson = readJson('package.json');
    expect(
      packageJson.devDependencies['@jnxplus/nx-micronaut-gradle']
    ).toBeTruthy();

    // Making sure the nx.json file contains the @jnxplus/nx-micronaut-gradle inside the plugins section
    const nxJson = readJson('nx.json');
    expect(
      nxJson.plugins.includes('@jnxplus/nx-micronaut-gradle')
    ).toBeTruthy();
  ...
  it('should create a java application', async () => {
    ...
    projectJson.targets = {
      ...projectJson.targets,
      'run-task': {
        executor: '@jnxplus/nx-micronaut-gradle:run-task',
      },
    };
  ...
  it('should use specified options to create an application', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:application ${randomName} --tags e2etag,e2ePackage --directory ${appDir} --groupId com.jnxplus --projectVersion 1.2.3 --packaging war --configFormat .yml --port ${port}`
    );
    ...
    expect(
      buildGradle.includes(
        'org.springframework.micronaut:spring-micronaut-starter-tomcat'
      )
    ).toBeTruthy();
  ...
  it('should generate an app with a simple package name', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:application ${randomName} --tags e2etag,e2ePackage --directory ${appDir} --groupId com.jnxplus --simplePackageName --projectVersion 1.2.3 --packaging war --configFormat .yml --port ${port}`
    );
  ...
  it('should create a kotlin application', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:application ${appName} --language kotlin --port ${port}`
    );
  ...
  it('--an app with aliases', async () => {
    ...
    await runNxCommandAsync(
      `g @jnxplus/nx-micronaut-gradle:app ${randomName} --t e2etag,e2ePackage --dir ${appDir} --groupId com.jnxplus --v 1.2.3 --packaging war --configFormat .yml --port ${port}`
    );
  ...
  it('directory with dash', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:application ${randomName} --directory deep/sub-dir --port ${port}`
    );
  ...
  it('should create a library', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:library ${libName}`
    );
  ...
  it('should create a kotlin library', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:library ${libName} --language kotlin`
    );
  ...
  it('should create a library with the specified properties', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:library ${randomName} --directory ${libDir} --tags e2etag,e2ePackage --groupId com.jnxplus --projectVersion 1.2.3`
    );
  ...
  it('should generare a lib with a simple package name', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:library ${randomName} --directory ${libDir} --tags e2etag,e2ePackage --groupId com.jnxplus --simplePackageName --projectVersion 1.2.3`
    );
  ...
  it('--a lib with aliases', async () => {
    ...
    await runNxCommandAsync(
      `g @jnxplus/nx-micronaut-gradle:lib ${randomName} --dir ${libDir} --t e2etag,e2ePackage --groupId com.jnxplus --v 1.2.3`
    );
  ...
  it('should add a lib to an app dependencies', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:library ${libName} --projects ${appName}`
    );
  ...
  it('should add a kotlin lib to a kotlin app dependencies', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:application ${appName} --language kotlin --packaging war`
    );
  ...
  it('should create an application with a simple name', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:application ${appName} --simpleName --tags e2etag,e2ePackage --directory ${appDir} --groupId com.jnxplus --projectVersion 1.2.3 --packaging war --configFormat .yml --port ${port}`
    );
  ...
  it('should create a library with a simple name', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:library ${libName} --simpleName --directory ${libDir} --tags e2etag,e2ePackage --groupId com.jnxplus --projectVersion 1.2.3`
    );
  ...
  it('should create a minimal java application', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:application ${appName} --minimal --port ${port}`
    );
  ...
  it('should create a minimal kotlin application', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:application ${appName} --language kotlin --minimal --port ${port}`
    );
  ...
  it('should skip starter code when generating a java library with skipStarterCode option', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:library ${libName} --skipStarterCode`
    );
  ...
  it('should skip starter code when generating a kotlin library with skipStarterCode option', async () => {
    ...
    await runNxCommandAsync(
      `generate @jnxplus/nx-micronaut-gradle:library ${libName} --language kotlin --skipStarterCode`
    );
