...
describe('nx-maven micronaut bom smoke', () => {
  ...
  it('should work', async () => {
    ...
    execSync(
      `npx nx g @jnxplus/nx-maven:lib ${testLib} --parentProject ${parentProjectName} --projects ${testApp} --framework micronaut`,
      execSyncOptions(),
    );
    ...
    execSync(
      `npx nx g @jnxplus/nx-maven:lib ${testLib2} --parentProject ${parentProjectName} --projects ${testApp2},${testApp3},${testApp4} --framework micronaut`,
      execSyncOptions(),
    );
